...
import com.kushnir.githhubclient.di.modules.ViewModelModule
import dagger.BindsInstance
import dagger.Component
import javax.inject.Singleton

@Singleton
@Component(modules = [AppModule::class, ActivityBuilder::class, NetModule::class, ViewModelModule::class])
